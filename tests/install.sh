...
EOF
	...
	assert_file "$REMOTE_HOME/.local/share/perch/Perch.app/Contents/MacOS/PerchApp"
	...
	assert_contains "$TMP_DIR/remote-install.out" "Installed PerchApp to $REMOTE_HOME/.local/share/perch/Perch.app"
	assert_contains "$TMP_DIR/remote-install.out" "  ✓ Opened $REMOTE_HOME/.local/share/perch/Perch.app"
